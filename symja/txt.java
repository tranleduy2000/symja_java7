...
public interface IExpr extends Comparable<IExpr>, GcdRingElem<IExpr>, Serializable, FieldElement<IExpr> {
     ...
     */
    public static  ofNullable(@Nonnull IExpr value) ;
     ...
     *                 <code>;</code>; the left-hand-side of the rule
     ...
     * int range.
     *
     * @param defaultValue the default value, if this integer is not in the <code>int</code>
     *                     range
     * @return the numeric value represented by this integer after conversion to
     * type <code>int</code>.
     */
    int toIntDefault(int defaultValue);
