...
//	private Monitor monitor = null;
     ...
     *
     * @param network the constraint network
     * @param option  the option for search strategy, or DEFAULT for default search
     *                strategy
     ...
     * {@link #stop()} method.
     *
     * @param timeout timeout in milliseconds (non-positive value means no timeout)
     */
     ...
     * method.
     *
     * @param handler solution handler
     */
