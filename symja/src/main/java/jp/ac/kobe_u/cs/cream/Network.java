...
public class Network implements Cloneable {
     ...
     * @throws IllegalArgumentException if <tt>v</tt> is already added to another network
     */
     ...
     * @throws IllegalArgumentException if <tt>c</tt> is already added to another network
     */
     ...
     *
     * @param v the objective variable
     */
     ...
     * from 0.
     *
     * @param i the index value of the variable to be returned
     * @return the <tt>i</tt>-th variable
     * @throws IndexOutOfBoundsException if <tt>i</tt> is out-of-range
     */
     ...
     * from 0.
     *
     * @param i the index value of the constraint to be returned
