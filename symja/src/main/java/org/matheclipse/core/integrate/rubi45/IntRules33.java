...
import static org.matheclipse.core.integrate.rubi45.UtilityFunctionCtors.ExpandLinearProduct;
...
import static org.matheclipse.core.integrate.rubi45.UtilityFunctionCtors.NormalizePowerOfLinear;
...
public class IntRules33 {
    public static IAST RULES = List(
            ...
            ISetDelayed(Int(Times(w_, Power(F_, Times(c_DEFAULT, v_)), Power(u_, m_DEFAULT)), x_Symbol),
            ...
            ISetDelayed(Int(Times(Power(F_, Plus(a_DEFAULT, Times(b_DEFAULT, Power(Plus(c_DEFAULT, Times(d_DEFAULT, x_)), n_)))), Power(Plus(e_DEFAULT, Times(f_DEFAULT, x_)), -1)), x_Symbol),
                    Condition(Integrate(Times(Power(FSymbol, Plus(a, Times(b, Power(Plus(c, Times(d, x)), n)))), Power(Plus(e, Times(f, x)), -1)), x), And(FreeQ(List(FSymbol, a, b, c, d, e, f, n), x), NonzeroQ(Plus(Times(d, e), Times(CN1, c, f)))))),
