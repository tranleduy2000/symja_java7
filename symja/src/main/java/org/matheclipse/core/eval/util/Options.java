...
public class Options {
     ...
     * <code>Factor(polynomial, Modulus-&gt;2)</code>.
     *
     * @param symbol             the options symbol for determining &quot;default option
     *                           values&quot;
     * @param currentOptionsList the AST where the option could be defined starting at position
     *                           <code>startIndex</code>
     * @param startIndex         the index from which tolook for options defined in
