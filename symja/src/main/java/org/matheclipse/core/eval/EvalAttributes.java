...
public class EvalAttributes {
     ...
     * @param ast  the <code>sublist</code> which should be added to the
     ...
     *
     * @param head             the head of the expression, which should be flattened.
     * @param sublist          the <code>sublist</code> which should be added to the
     *                         <code>result</code> list.
     * @param result           the <code>result</code> list, where all sublist elements with
