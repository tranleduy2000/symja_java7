...
public class PatternMatcherAndEvaluator extends PatternMatcher implements Externalizable {
     ...
     * @param rightHandSide the result which should be evaluated if the "pattern-matching"
     *                      succeeds
     */
     ...
     *
     * @param setSymbol     the symbol which defines this pattern-matching rule (i.e. Set,
     *                      SetDelayed,...)
     * @param leftHandSide  could contain pattern expressions for "pattern-matching"
     * @param rightHandSide the result which should be evaluated if the "pattern-matching"
     *                      succeeds
