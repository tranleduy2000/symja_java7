...
import org.matheclipse.core.builtin.booleanfunction.BooleanFunctions;
...
public abstract class ExprImpl implements IExpr {
     ...
     *
     * @param consumer block to be executed if this expression unequals
     *                 <code>F.NIL</code>
     */
     ...
     * @param header the header element at position 0, which should be tested
     * @param length the size the AST expression must have
     * @param args   the arguments of this AST which should be tested, if they are
     ...
     *
     * @param headerStr string representation of the <b>header element</b> at index
     ...
     *
     * @param pattern a pattern-matching expression
     * @param heads   if set to <code>false</code>, only the arguments of an IAST should
     ...
     * elements are lists with the header <code>List</code> and have the same size.
     *
     * @param setMatrixFormat set the <code>IAST.IS_MATRIX</code> flag for formatting as a
     *                        matrix.
     * @return <code>null</code> if the expression is not a matrix
     */
     ...
     * associated public value (for example <code>0</code> is the public value for
    ...
    /**
     * Return <code>true</code>, if the expression is a pattern object with an
     * associated optional value (for example <code>value</code> is the public
     ...
     * arguments.
     *
     * @param size the size of an AST for which <code>Span[]</code> should be
     *             applied.
     ...
     * This function is used in <code>Simplify</code> as the public
     * &quot;complexity function&quot;.
     *
     * @return
     */
     ...
     * </p>
     *
     * @param operator  the if the head of this expression equals <code>operator</code>,
     *                  otherwise return <code>F.NIL</code>.
     * @param predicate the predicate which filters each element in this AST
     * @param initTrue  the result for the 1st result element, if the predicate doesn't
     *                  give <code>true</code> for any of the arguments in this AST.
     * @param initFalse the result for the 2nd result element, if the predicate doesn't
     ...
     *
     * @param function if the unary functions <code>apply()</code> method returns
     ...
     *
     * @param astRules rules of the form <code>x-&gt;y</code> or
     ...
     *
     * @param astRules rules of the form <code>position-&gt;y</code> or
    ...
    /**
     * Converts this number to an <code>int</code> value; unlike {@link #}
     * this method returns <code>public Value</code> if the value of this integer
     * isn't in the range <code>Integer.MIN_VALUE</code> to
     * <code>Integer.MAX_VALUE</code> or the expression is not convertible to the
     * int range.
     *
     * @param defaultValue the public value, if this integer is not in the <code>int</code>
     *                     range
     ...
     *
     * @param map               for every given symbol argument return the associated unique slot
     *                          from this map
