...
public class Solve extends AbstractFunctionEvaluator {
     ...
     * @param expr
     * @param engine
     * @param evalTogether evaluate <code>Together[expr]</code> before determining numerator
    ...
    /**
     * @param termsEqualZeroList     the list of expressions extracted form the given equations, which
