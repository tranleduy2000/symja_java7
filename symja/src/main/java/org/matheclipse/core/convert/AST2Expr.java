...
public class AST2Expr {
    ...
    public final static String[] FUNCTION_STRINGS = {"Abort", "Abs", "AbsArg", "AddTo", "AllTrue", "And",
            ...
            "BellY", "BernoulliB", "BernoulliDistribution", "BesselI", "BesselJ", "BesselK", "BesselY", "Binomial",
            "BinomialDistribution", "Blank", "Block", "Boole", "BooleanQ", "BooleanConvert", "BooleanMinimize",
            ...
            "CentralMoment", "CharacteristicPolynomial", "ChebyshevT", "ChebyshevU", "ChessboardDistance",
            ...
            "Equivalent", "Erf", "Erfc", "Erfi", "EuclideanDistance", "EulerE", "EulerPhi", "EvenQ", "ExactNumberQ",
            "Except", "Exists", "Exp", "Expand", "ExpandAll", "ExpIntegralE", "ExpIntegralEi", "Exponent", "Export",
            "ExtendedGCD", "Extract", "Factor", "Factorial", "Factorial2", "FactorInteger", "FactorSquareFree",
            "FactorSquareFreeList", "FactorTerms", "Flatten", "Fibonacci", "FindInstance", "FindRoot", "First", "Fit",
            "FixedPoint", "FixedPointList", "Floor", "Fold", "FoldList", "For", "ForAll", "FractionalPart", "FreeQ",
            "FresnelC", "FresnelS", "FrobeniusSolve", "FromCharacterCode", "FromContinuedFraction",
            "FromPolarCoordinates", "FullForm", "FullSimplify", "Function", "Gamma", "Gather", "GCD", "GegenbauerC",
            "GeometricMean", "Get", "Graphics", "Graphics3D", "Graphics3D", "Greater", "GreaterEqual", "GroebnerBasis",
            ...
            "LeafCount", "LaguerreL", "LaplaceTransform", "LegendreP", "Length", "Less", "LessEqual", "LetterQ",
            "Level", "LevelQ", "Limit", "Line", "LinearModelFit", "LinearProgramming", "LinearSolve", "LiouvilleLambda",
            "List", "ListConvolve", "ListCorrelate", "ListQ", "Log", "Log2", "Log10", "LogGamma", "LogicalExpand",
            "LogisticSigmoid", "LogIntegral", "LowerCaseQ", "LucasL", "LUDecomposition", "MachineNumberQ",
            ...
            "Options", "Or", "Order", "Ordering", "OrderedQ", "Out", "Outer", "Package", "PadLeft", "PadRight",
            ...
            "Precision", "PreDecrement", "PreIncrement", "Prepend", "PrependTo", "Prime", "PrimeOmega", "PrimePi",
            "PrimePowerQ", "PrimeQ", "PrimitiveRootList", "Print", "Product", "ProductLog", "PseudoInverse", "Put",
            "QRDecomposition", "Quiet", "Quit", "Quotient", "RandomChoice", "RandomInteger", "RandomReal",
            "RandomSample", "Range", "Rational", "Rationalize", "Re", "RealNumberQ", "Reap", "Rectangle", "Reduce",
