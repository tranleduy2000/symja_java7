...
public class Convert {
     ...
     * @throws WrongArgumentType         if not all elements are convertable to a <code>double</code>
     *                                   value.
     * @throws ClassCastException
     * @throws IndexOutOfBoundsException
     ...
     * @throws WrongArgumentType         if not all elements are convertible to a <code>double</code>
     *                                   value.
     * @throws ClassCastException
     * @throws IndexOutOfBoundsException
