...
public class BinaryBindIth1st implements IUnaryIndexFunction<IExpr, IExpr> {
     ...
     * {@code apply} method.
     *
     * @param constant1 a &quot;template AST&quot; with all arguments set with a
     *                  predefined value.
     * @param constant2 a &quot;template AST&quot; with all arguments set with a
     *                  predefined value.
     */
     ...
     * @param firstArg the i-th argument in the new AST
     */
    @Override
