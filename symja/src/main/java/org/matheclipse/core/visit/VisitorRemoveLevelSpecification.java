...
public class VisitorRemoveLevelSpecification extends VisitorLevelSpecification {
     ...
     * @param includeHeads   set to <code>true</code>, if the header of an AST expression
     *                       should be included
     * @throws MathException if the <code>expr</code> is not a <i>level specification</i>
     * @see
     */
     ...
     * removed!
     *
     * @param clonedAST an AST where arguments could be removed.
     */
    @Override
