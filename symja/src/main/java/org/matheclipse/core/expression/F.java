...
import org.matheclipse.core.builtin.intfunction.IntegerFunctions;
...
public class F {
    ...
    /**
     * Complex imaginary unit. The parsed symbol &quot;I&quot; is converted on input
     * to this constant.
     */
     ...
     * Create a new abstract syntax tree (AST).
     *
     * @param head the header symbol of the function. If the ast represents a
     *             function like <code>f[x,y], Sin[x],...</code>, the
     *             <code>head</code> will be an instance of type ISymbol.
     * @param a
     * @return
     ...
     *
     * @param condition additional condition which should be checked in pattern-matching
     * @param def       if <code>true</code> use a default value in pattern-matching if an
     ...
     *
     * @param condition    additional condition which should be checked in pattern-matching
     * @param defaultValue use this <code>defaultValue</code> in pattern-matching if an
     *                     argument is optional
     * @return IPattern
     */
     ...
     * @param def             if <code>true</code>, the pattern can match to a default value
     *                        associated with the AST's head the pattern is used in.
     * @param zeroArgsAllowed if <code>true</code> 0 argument sequences are allowed for this
     *                        pattern
     * @return IPattern
     */
    ...
    /**
     * <p>
     * Get or create a global predefined symbol which is retrieved from the SYSTEM
     * context map or created or retrieved from the SYSTEM context variables map.
     * </p>
     * <p>
     ...
     *
     * @param symbolName the name of the symbol
     * @param setEval    if <code>true</code> determine and assign the built-in evaluator
     ...
     * @param copies the initial capacity (i.e. number of arguments without the header
     *               element) of the list.
     * @return
     */
     ...
     * Create a symbolic complex number
     *
     * @param realPart the real double value part which should be converted to a complex
     *                 number
     * @param imagPart the imaginary double value part which should be converted to a
     *                 complex number
     * @return IFraction
     */
     ...
     *
     * @param value the rational value which should be converted to a fractional
     *              number
     * @return IFraction
     */
     ...
     *
     * @param fileName         <code>null</code> or optional text filename, which includes the
     ...
     *
     * @param capacity the assumed number of arguments (+ 1 for the header expression is
     *                 added internally).
     * @return
     */
     ...
     * <code>IExpr#negate()</code> method does evaluations, which don't agree with
