...
import org.matheclipse.core.interfaces.defaultmethod.IRationalImpl;
 ...
 * @see BigFractionSym
 */
public abstract class AbstractFractionSym extends IRationalImpl implements IFraction {
     ...
     * @param epsilon maximum error allowed. The resulting fraction is within epsilon of value, in absolute terms.
     * @return
     */
