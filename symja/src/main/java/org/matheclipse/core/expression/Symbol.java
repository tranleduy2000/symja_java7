...
public class Symbol extends IExprImpl implements ISymbol, Serializable {
    ...
    /**
     * If this symbol has attribute <code>CONSTANT</code> and the symbol's evaluator is of instance
	...
	/** {@inheritDoc} */
	@Override
	public final IPatternMatcher putDownRule(final RuleType symbol, final boolean equalRule,
	...
	/** {@inheritDoc} */
	@Override
	public final IPatternMatcher putDownRule(final RuleType setSymbol, final boolean equalRule,
	...
	/** {@inheritDoc} */
	@Override
	public final IPatternMatcher putUpRule(final RuleType symbol, boolean equalRule, IAST leftHandSide,
			IExpr rightHandSide) {
	...
	/** {@inheritDoc} */
	@Override
	public final IPatternMatcher putUpRule(final RuleType setSymbol, final boolean equalRule,
	...
	@Override
	public final void removeRule(final RuleType setSymbol, final boolean equalRule, final IExpr leftHandSide,
			boolean packageMode) {
		if (!packageMode) {
			if (isLocked(packageMode)) {
				throw new RuleCreationError(leftHandSide);
