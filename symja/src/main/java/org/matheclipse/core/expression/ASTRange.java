...
public class ASTRange extends AbstractList<IExpr> implements Iterable<IExpr> {
     ...
     *
     * @param filterList the elements which match the predicate
     * @param restList   the elements which don't match the predicate
     * @param function   the function which filters each element in the range by
     ...
     * given predicate
     *
     * @param predicate a predicate that analyzes the given elements
     ...
     * @param leftArg        left argument of the binary functions <code>apply()</code>
     *                       method.
     * @return
     */
     ...
     * @param rightArg       right argument of the binary functions <code>apply()</code>
     *                       method.
