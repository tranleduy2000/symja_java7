...
import org.matheclipse.core.interfaces.impl.IntegerImpl;
 ...
 * @see BigIntegerSym
 */
public abstract class AbstractIntegerSym extends IntegerImpl implements Externalizable {
    /**
     ...
     *
     * @param that if that is of type IntegerSym calculate the extended GCD otherwise
