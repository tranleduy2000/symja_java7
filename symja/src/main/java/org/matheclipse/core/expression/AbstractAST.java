...
import org.matheclipse.core.interfaces.impl.ASTImpl;
...
public abstract class AbstractAST extends ASTImpl {
     ...
     * <code>restAST</code>.
     *
     * @param filterAST the non-null elements which were returned by the
     *                  <code>function#apply()</code> method
     * @param restAST   the arguments in this <code>AST</code> for which the
     *                  <code>function#apply()</code> method returned <code>null</code>
     * @param function  the function which filters each argument by returning a value
